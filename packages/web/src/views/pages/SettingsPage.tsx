  ...
  return (
    <div className="pluse-page pluse-project-page pluse-settings-page">
      <div className="pluse-detail-shell">
        <div className="pluse-detail-hero">
          <div className="pluse-detail-hero-main">
            <div className="pluse-detail-title-row">
              <h1 className="pluse-info-path">系统 Prompt</h1>
              <span className="pluse-inline-pill">全局</span>
            </div>
            <p className="pluse-detail-summary">
              作用于所有项目。项目级 Prompt 在各项目设置里单独编辑。
            </p>
          </div>
        </div>
        ...
        <div className="pluse-detail-grid pluse-settings-grid">
          <section className="pluse-detail-section">
            ...
            <textarea
              ...
              rows={14}
              placeholder="输入全局系统 Prompt"
            />
            <p className="pluse-info-copy">当前内容会先于项目 Prompt 注入到所有 Quest。</p>
          </section>
